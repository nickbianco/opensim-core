/* -------------------------------------------------------------------------- *
 *                        OpenSim:  MobilityLinearDamper.cpp                  *
 * -------------------------------------------------------------------------- *
...
MobilityLinearDamper::MobilityLinearDamper(const std::string& coordinateName, double damping) {
    constructProperties();
    set_coordinate(coordinateName);
    set_damping(damping);
}

void MobilityLinearDamper::constructProperties() {
    constructProperty_coordinate("");
    constructProperty_damping(0.0);
}

void MobilityLinearDamper::extendAddToSystem(SimTK::MultibodySystem& system) const {
