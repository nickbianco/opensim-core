...
void simulateScholz2015GeometryPath() {
    ...
    addContact(model, "contact0", 
               &model.updComponent<Body>("/bodyset/b0"), 
               SimTK::Vec3(0), transform, params);

    addContact(model, "contact1", 
               &model.updComponent<Body>("/bodyset/b1"), 
               SimTK::Vec3(0), transform, params);

    addContact(model, "contact2", 
               &model.updComponent<Body>("/bodyset/b1"), 
               SimTK::Vec3(-1, 0, 0), transform, params);
    ...
    // path.setOrigin(model.getComponent<Body>("/bodyset/root"), SimTK::Vec3(0., 0, 0));
    // path.setInsertion(model.getComponent<Body>("/bodyset/b0"), 
    //         SimTK::Vec3(-1.0, 0.1, 0));
