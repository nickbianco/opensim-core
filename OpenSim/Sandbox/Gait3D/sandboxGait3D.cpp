...
int main(int argc, char* argv[]) {
    ...
    // ----------
    if (jointType == JointType::Custom) {
        MobilityLinearStop* lumbarStop0 = 
            new MobilityLinearStop("lumbar_coord_0", 500, 2.95953, 
                                SimTK::convertDegreesToRadians(-30.0), 
                                SimTK::convertDegreesToRadians(30.0));
        lumbarStop0->setName("lumbar_coord_0_stop");
        model.addForce(lumbarStop0);

        MobilityLinearStop* lumbarStop1 = 
            new MobilityLinearStop("lumbar_coord_1", 500, 2.95953, 
                                SimTK::convertDegreesToRadians(-30.0), 
                                SimTK::convertDegreesToRadians(30.0));
        lumbarStop1->setName("lumbar_coord_1_stop");
        model.addForce(lumbarStop1);

        MobilityLinearStop* lumbarStop2 = 
            new MobilityLinearStop("lumbar_coord_2", 500, 2.95953, 
                                SimTK::convertDegreesToRadians(-30.0), 
                                SimTK::convertDegreesToRadians(30.0));
        lumbarStop2->setName("lumbar_coord_2_stop");
        model.addForce(lumbarStop2);

        MobilityLinearStop* leftHipStop0 = 
            new MobilityLinearStop("hip_l_coord_0", 500, 2.95953, 
                                SimTK::convertDegreesToRadians(-30.0), 
                                SimTK::convertDegreesToRadians(30.0));
        leftHipStop0->setName("hip_l_coord_0_stop");
        model.addForce(leftHipStop0);

        MobilityLinearStop* leftHipStop1 = 
            new MobilityLinearStop("hip_l_coord_1", 500, 2.95953, 
                                SimTK::convertDegreesToRadians(-30.0), 
                                SimTK::convertDegreesToRadians(30.0));
        leftHipStop1->setName("hip_l_coord_1_stop");
        model.addForce(leftHipStop1);

        MobilityLinearStop* leftHipStop2 = 
            new MobilityLinearStop("hip_l_coord_2", 500, 2.95953, 
                                SimTK::convertDegreesToRadians(-30.0), 
                                SimTK::convertDegreesToRadians(30.0));
        leftHipStop2->setName("hip_l_coord_2_stop");
        model.addForce(leftHipStop2);

        MobilityLinearStop* rightHipStop0 = 
            new MobilityLinearStop("hip_r_coord_0", 500, 2.95953, 
                                SimTK::convertDegreesToRadians(-30.0), 
                                SimTK::convertDegreesToRadians(30.0));
        rightHipStop0->setName("hip_r_coord_0_stop");
        model.addForce(rightHipStop0);

        MobilityLinearStop* rightHipStop1 = 
            new MobilityLinearStop("hip_r_coord_1", 500, 2.95953, 
                                SimTK::convertDegreesToRadians(-30.0), 
                                SimTK::convertDegreesToRadians(30.0));
        rightHipStop1->setName("hip_r_coord_1_stop");
        model.addForce(rightHipStop1);

        MobilityLinearStop* rightHipStop2 = 
            new MobilityLinearStop("hip_r_coord_2", 500, 2.95953, 
                                SimTK::convertDegreesToRadians(-30.0), 
                                SimTK::convertDegreesToRadians(30.0));
    ...
    manager.setIntegratorMaximumStepSize(1e-1);
