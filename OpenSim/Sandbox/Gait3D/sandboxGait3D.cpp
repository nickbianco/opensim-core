...
int main(int argc, char* argv[]) {
    ...
    // Joint stops
    // ----------
    SimTK::Real stopStiffness = 500;
    SimTK::Real stopDamping = 2.95;
    if (jointType == JointType::Custom) {
        CoordinateLinearStop* lumbarStop0 =
            new CoordinateLinearStop("lumbar_coord_0", stopStiffness, stopDamping,
        ...
        CoordinateLinearStop* lumbarStop1 =
            new CoordinateLinearStop("lumbar_coord_1", stopStiffness, stopDamping,
                                SimTK::convertDegreesToRadians(-20.0),
                                SimTK::convertDegreesToRadians(20.0));
        ...
        CoordinateLinearStop* lumbarStop2 =
            new CoordinateLinearStop("lumbar_coord_2", stopStiffness, stopDamping,
                                SimTK::convertDegreesToRadians(-20.0),
                                SimTK::convertDegreesToRadians(20.0));
        ...
        CoordinateLinearStop* leftHipStop0 =
            new CoordinateLinearStop("hip_l_coord_0", stopStiffness, stopDamping,
        ...
        CoordinateLinearStop* leftHipStop1 =
            new CoordinateLinearStop("hip_l_coord_1", stopStiffness, stopDamping,
                                SimTK::convertDegreesToRadians(-30.0),
                                SimTK::convertDegreesToRadians(30.0));
        ...
        CoordinateLinearStop* leftHipStop2 =
            new CoordinateLinearStop("hip_l_coord_2", stopStiffness, stopDamping,
                                SimTK::convertDegreesToRadians(-30.0),
                                SimTK::convertDegreesToRadians(30.0));
        ...
        CoordinateLinearStop* rightHipStop0 =
            new CoordinateLinearStop("hip_r_coord_0", stopStiffness, stopDamping,
                                SimTK::convertDegreesToRadians(-30.0),
                                SimTK::convertDegreesToRadians(30.0));
        ...
        CoordinateLinearStop* rightHipStop1 =
            new CoordinateLinearStop("hip_r_coord_1", stopStiffness, stopDamping,
                                SimTK::convertDegreesToRadians(-30.0),
                                SimTK::convertDegreesToRadians(30.0));
        ...
        CoordinateLinearStop* rightHipStop2 =
            new CoordinateLinearStop("hip_r_coord_2", stopStiffness, stopDamping,
                                SimTK::convertDegreesToRadians(-30.0),
                                SimTK::convertDegreesToRadians(30.0));
    ...
    CoordinateLinearStop* leftKneeStop =
        new CoordinateLinearStop("knee_l_coord_0", stopStiffness, stopDamping,
    ...
    CoordinateLinearStop* rightKneeStop =
        new CoordinateLinearStop("knee_r_coord_0", stopStiffness, stopDamping,
                              SimTK::convertDegreesToRadians(-120.0),
                              SimTK::convertDegreesToRadians(-3.0));
    ...
    CoordinateLinearStop* leftAnkleStopX =
        new CoordinateLinearStop("ankle_l_coord_0", stopStiffness, stopDamping,
    ...
    CoordinateLinearStop* rightAnkleStopX =
        new CoordinateLinearStop("ankle_r_coord_0", stopStiffness, stopDamping,
                              SimTK::convertDegreesToRadians(-60.0),
                              SimTK::convertDegreesToRadians(25.0));
