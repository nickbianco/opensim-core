/* -------------------------------------------------------------------------- *
 *                        OpenSim:  MobilityLinearStop.cpp                    *
 * -------------------------------------------------------------------------- *
...
MobilityLinearStop::MobilityLinearStop() {
    constructProperties();
}

MobilityLinearStop::MobilityLinearStop(const std::string& coordinateName, double stiffness, 
...
void MobilityLinearStop::constructProperties() {
...
void MobilityLinearStop::extendAddToSystem(SimTK::MultibodySystem& system) const {
