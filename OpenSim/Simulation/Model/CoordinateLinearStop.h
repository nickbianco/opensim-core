#ifndef OPENSIM_COORDINATELINEARSTOP_H
#define OPENSIM_COORDINATELINEARSTOP_H
/* -------------------------------------------------------------------------- *
 *                     OpenSim:  CoordinateLinearStop.h                       *
 * -------------------------------------------------------------------------- *
...
class OSIMSIMULATION_API CoordinateLinearStop : public Force {
    OpenSim_DECLARE_CONCRETE_OBJECT(CoordinateLinearStop, Force);
public:
    ...
    CoordinateLinearStop(const std::string& coordinateName, double stiffness,
...
#endif // OPENSIM_COORDINATELINEARSTOP_H